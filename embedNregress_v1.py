...
def embed_loss(y_true,embed_true):
   ...
   #Scale_Matrix_y = tf.linalg.tensor_diag(tf.norm(y_true,ord='euclidean'
    ...
    return tf.norm(IP_Matrix_e/tf.norm(IP_Matrix_e,axis=[0,1],ord='fro')-IP_Matrix_y/tf.norm(IP_Matrix_y,axis=[0,1],ord='fro'),axis=[0,1],ord='fro')
...
def customRegressLoss(y_model:tf.Variable, y_true:tf.Variable,embed_true:tf.Variable, regress_y_model:tf.Variable,
